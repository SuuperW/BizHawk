...
{
	internal class FakeMainFormTools : IMainFormForTools
	{
		public FakeMainFormTools(IMainFormForApi forApi)
		{
			MainForApi = forApi;
		}
		...
		public bool IsTurboing => false;

		public bool IsFastForwarding => throw new NotImplementedException();
		...
		public IMainFormForApi MainForApi { get; }

		public void AddOnScreenMessage(string message, [LiteralExpected] int? duration = null) => throw new NotImplementedException();
		...
		public bool StartNewMovie(IMovie movie, bool newMovie) => throw new NotImplementedException();
